...
import 'package:mybungapads/profile.dart';
import 'package:mybungapads/adminproduct.dart';
import 'package:mybungapads/user.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  String server = "https://saujanaeclipse.com/bbsystem";
          ...
          floatingActionButton: FloatingActionButton.extended(
            onPressed: () async {
              if (widget.user.email == "unregistered") {
                ...
                return;
              } else if (widget.user.email == "admin@bbsystem.com") {
  ...
  _addtocartdialog(int index) {
    if (widget.user.email == "unregistered@bbsystem.com") {
      Toast.show("Please register to use this function", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
    if (widget.user.email == "admin@bbsystem.com") {
      Toast.show("Admin Mode!!!", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
