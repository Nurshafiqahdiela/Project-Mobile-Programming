...
import 'package:mybungapads/login.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  String urlRegister =
      "https://saujanaeclipse.com/bbsystem/php/register_user.php";
  ...
  Widget upperHalf(BuildContext context) {
    return Container(
      ...
      child: Image.asset('assets/images/splashscreen2.jpg', fit: BoxFit.fill),
    );
  }
